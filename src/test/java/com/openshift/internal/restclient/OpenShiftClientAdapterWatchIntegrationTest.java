...
public class OpenShiftClientAdapterWatchIntegrationTest {

	private static final Logger LOG = LoggerFactory.getLogger(OpenShiftClientAdapterWatchIntegrationTest.class);
	...
	public void setup() {
		...
		client = helper.createClientForBasicAuth(ClientType.FABRIC8IO);
		final String name = helper.generateNamespace();
		IResource projRequest = client.getResourceFactory().stub(ResourceKind.PROJECT, name);
